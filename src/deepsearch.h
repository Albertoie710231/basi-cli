...
/* deep_search: an IterResearch deep-research loop (ported from Alibaba
   DeepResearch / WebResearcher). Runs N rounds in an ISOLATED llama_context
   ...
   silent. Returns the malloc'd final cited answer (caller frees). `vocab` must
   be the vocabulary of `model`. */
